...
public class Zoo {
    ...
    public Animal getSwimChampions() {
        List<Swimming> swimmers = getSwimmingList();
        Swimming champion = swimmers.get(0);
        for (Swimming r : swimmers) {
